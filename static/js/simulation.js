...
var $author$project$Main$AManger = {$: 'AManger'};
var $author$project$Main$BoutDeTable = {$: 'BoutDeTable'};
var $author$project$Main$Centimetre = function (a) {
	return {$: 'Centimetre', a: a};
};
var $author$project$Main$Chene = {$: 'Chene'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			essence: $author$project$Main$Chene,
			largeur: $author$project$Main$Centimetre(70),
			longueur: $author$project$Main$Centimetre(140),
			positionPietement: $author$project$Main$BoutDeTable,
			type_: $author$project$Main$AManger
		},
		...
		switch (msg.$) {
			case 'LongueurChanged':
				...
				var longueur = A2(
					...
					A2(
						$elm$core$Maybe$map,
						$author$project$Main$Centimetre,
					...
					return _Utils_Tuple2(
						{
							...
							largeur: $author$project$Main$Centimetre(50),
							longueur: $author$project$Main$Centimetre(110),
...
var $author$project$Main$Basse = {$: 'Basse'};
var $author$project$Main$Central = {$: 'Central'};
...
var $author$project$Images$bubinga = '/images/simulation/essences-img/bubinga.jpg';
var $author$project$Images$chataignier = '/images/simulation/essences-img/chataigner.jpg';
var $author$project$Images$chene = '/images/simulation/essences-img/chene.jpg';
var $author$project$Images$frene = '/images/simulation/essences-img/frene.jpg';
...
var $author$project$Main$imageField = F5(
	function (fieldId, selected, labelString, image, event) {
		return A2(
			$elm$html$Html$label,
			_List_fromArray(
				[
...
var $author$project$Images$noyer = '/images/simulation/essences-img/noyer.jpg';
var $author$project$Images$olivier = '/images/simulation/essences-img/olivier.jpg';
var $author$project$Main$essenceField = F2(
	function (table, essence) {
		var _v0 = function () {
			switch (essence.$) {
				case 'Chene':
					return _Utils_Tuple3('chene', 'Chêne', $author$project$Images$chene);
				case 'Chataignier':
					return _Utils_Tuple3('chataignier', 'Châtaignier', $author$project$Images$chataignier);
				case 'Frene':
					return _Utils_Tuple3('frene', 'Frêne', $author$project$Images$frene);
				case 'Noyer':
					return _Utils_Tuple3('noyer', 'Noyer', $author$project$Images$noyer);
				case 'Prestige':
					return _Utils_Tuple3('prestige', 'Prestige', $author$project$Images$olivier);
				default:
					return _Utils_Tuple3('exotique', 'Exotique', $author$project$Images$bubinga);
			}
		}();
		var fieldId = _v0.a;
		...
		var image = _v0.c;
		return A5(
			$author$project$Main$imageField,
			fieldId,
			_Utils_eq(table.essence, essence),
			labelString,
			image,
			$author$project$Main$EssenceChanged(essence));
	});
var $author$project$Main$Chataignier = {$: 'Chataignier'};
var $author$project$Main$Exotique = {$: 'Exotique'};
var $author$project$Main$Frene = {$: 'Frene'};
var $author$project$Main$Noyer = {$: 'Noyer'};
var $author$project$Main$Prestige = {$: 'Prestige'};
var $author$project$Main$essences = _List_fromArray(
	[$author$project$Main$Chene, $author$project$Main$Chataignier, $author$project$Main$Frene, $author$project$Main$Noyer, $author$project$Main$Prestige, $author$project$Main$Exotique]);
...
var $author$project$Main$positionPietementField = F2(
	function (table, positionPietement) {
		...
		return A5(
			...
			labelString,
			image,
			$author$project$Main$PositionPietementChanged(positionPietement));
	});
var $elm$core$String$fromFloat = _String_fromNumber;
var $author$project$Main$print = function (prix) {
	var _int = prix.a;
	return $elm$core$String$fromFloat(_int) + ' €';
};
var $author$project$Main$Euros = function (a) {
	return {$: 'Euros', a: a};
};
var $author$project$Main$plus = F2(
	function (a, b) {
		...
		var a1 = _v0.a.a;
		var b1 = _v0.b.a;
		return $author$project$Main$Euros(a1 + b1);
	});
var $author$project$Main$prixEssence = function (table) {
	var _v0 = table.essence;
	switch (_v0.$) {
		case 'Chene':
			return $author$project$Main$Euros(900);
		case 'Chataignier':
			return $author$project$Main$Euros(900);
		case 'Frene':
			return $author$project$Main$Euros(850);
		case 'Noyer':
			return $author$project$Main$Euros(950);
		case 'Prestige':
			return $author$project$Main$Euros(1000);
		default:
			return $author$project$Main$Euros(900);
	}
};
var $author$project$Main$prixPietement = function (table) {
	var _v0 = table.type_;
	if (_v0.$ === 'Basse') {
		var _v1 = table.positionPietement;
		if (_v1.$ === 'BoutDeTable') {
			return $author$project$Main$Euros(180);
		} else {
			return $author$project$Main$Euros(250);
		}
	} else {
		var _v2 = table.positionPietement;
		if (_v2.$ === 'BoutDeTable') {
			return $author$project$Main$Euros(250);
		} else {
			return $author$project$Main$Euros(500);
		}
	}
};
var $elm$core$Basics$round = _Basics_round;
var $author$project$Main$roundPrix = function (prix) {
	var _float = prix.a;
	return $author$project$Main$Euros(
		10 * $elm$core$Basics$round(_float / 10));
};
var $author$project$Main$centimetres = function (taille) {
	var _int = taille.a;
	return _int;
};
...
var $author$project$Main$surfaceM2 = function (table) {
	return function (s) {
		return s / 10000;
	}(
		function (_v0) {
			...
			A3(
				...
				$author$project$Main$centimetres,
				$author$project$Main$centimetres,
				_Utils_Tuple2(table.largeur, table.longueur))));
};
var $author$project$Main$times = F2(
	function (_float, prix) {
		var euros = prix.a;
		return $author$project$Main$Euros(euros * _float);
	});
var $author$project$Main$prixTotal = function (table) {
	return $author$project$Main$roundPrix(
		A2(
			$author$project$Main$plus,
			$author$project$Main$prixPietement(table),
			A2(
				$author$project$Main$times,
				$author$project$Main$surfaceM2(table),
				$author$project$Main$prixEssence(table))));
};
var $author$project$Main$TableTypeChanged = function (a) {
	return {$: 'TableTypeChanged', a: a};
};
var $author$project$Images$tableAManger = '/images/simulation/table-a-manger.jpg';
var $author$project$Images$tableBasse = '/images/simulation/table-basse.jpg';
var $author$project$Main$tableTypeField = F2(
	function (table, tableType) {
		var _v0 = function () {
			if (tableType.$ === 'Basse') {
				return _Utils_Tuple3('basse', 'Table basse', $author$project$Images$tableBasse);
			} else {
				return _Utils_Tuple3('a-manger', 'Table à manger', $author$project$Images$tableAManger);
			}
		}();
		var fieldId = _v0.a;
		var labelString = _v0.b;
		...
		return A5(
			$author$project$Main$imageField,
			fieldId,
			_Utils_eq(table.type_, tableType),
			labelString,
			image,
			$author$project$Main$TableTypeChanged(tableType));
	});
var $author$project$Main$tailles = function (tableType) {
	if (tableType.$ === 'Basse') {
		return {
			largeurs: {
				max: $author$project$Main$Centimetre(300),
				min: $author$project$Main$Centimetre(50)
			},
			longueurs: {
				max: $author$project$Main$Centimetre(300),
				min: $author$project$Main$Centimetre(50)
		...
		return {
			largeurs: {
				max: $author$project$Main$Centimetre(600),
				min: $author$project$Main$Centimetre(65)
			},
			longueurs: {
				max: $author$project$Main$Centimetre(600),
				min: $author$project$Main$Centimetre(65)
...
var $author$project$Main$taillesFields = F2(
	function (table, _v0) {
						...
						_List_fromArray(
							[
								...
								'Longueur: ' + $elm$core$String$fromInt(
									$author$project$Main$centimetres(table.longueur)))
							])),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt(
									$author$project$Main$centimetres(longueurs.min))),
								$elm$html$Html$Attributes$max(
								$elm$core$String$fromInt(
									$author$project$Main$centimetres(longueurs.max))),
						...
						_List_fromArray(
							[
								...
								'Largeur: ' + $elm$core$String$fromInt(
									$author$project$Main$centimetres(table.largeur)))
							])),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$min(
								$elm$core$String$fromInt(
									$author$project$Main$centimetres(largeurs.min))),
								$elm$html$Html$Attributes$max(
								$elm$core$String$fromInt(
									$author$project$Main$centimetres(largeurs.max))),
								$elm$html$Html$Attributes$step('5'),
								$elm$html$Html$Attributes$value(
								$elm$core$String$fromInt(
									$author$project$Main$centimetres(table.largeur))),
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							A2(
								$elm$core$List$map,
								$author$project$Main$tableTypeField(table),
								_List_fromArray(
									[$author$project$Main$AManger, $author$project$Main$Basse]))),
							A2(
							$elm$html$Html$h2,
							_List_Nil,
							_List_fromArray(
							...
							A2(
								$elm$core$List$map,
								$author$project$Main$essenceField(table),
								$author$project$Main$essences)),
							A2(
							$elm$html$Html$h2,
							_List_Nil,
							_List_fromArray(
					...
					_Utils_ap(
						A2(
							$author$project$Main$taillesFields,
							table,
							$author$project$Main$tailles(table.type_)),
						_List_fromArray(
							[
								A2(
								$elm$html$Html$h2,
								...
								A2(
									$elm$core$List$map,
									$author$project$Main$positionPietementField(table),
									_List_fromArray(
										[$author$project$Main$BoutDeTable, $author$project$Main$Central])))
							])))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
						...
						_List_fromArray(
							[
								...
								$author$project$Main$print(
									$author$project$Main$prixTotal(table)))
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
